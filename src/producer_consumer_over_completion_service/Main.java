...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // It allows submitting callable tasks and offers queue-like methods to to retrieve results
        // It is reasonable to create private disposable CompletionServices providing a common ExecutorService
